...
####################################################################
    ...
    valid_codigo_identifi_len = df_identifi['codigo'].apply(lambda x: len(x) == codigo_len)
...
####################################################################
    ...
    valid_lito_respuestas_len = df_respuestas['lito'].apply(lambda x: len(x) == lito_len)
